...
<div class="app">
  ...
  <aside class="side" id="side" aria-label="Super admin navigation">
    <div class="brand"><a class="brand__logo" href="#dashboard"><img src="/logo.png?v=5" alt="" class="brand__mark" />Think <i>Decor</i></a><span class="brand__tag">Super admin</span><button class="iconbtn navclose" id="navclose" aria-label="Close menu"><span data-ic="x"></span></button></div>
